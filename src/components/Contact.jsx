...
const Contact = () => {
  ...
  return (
    <section id="contact" className="relative overflow-hidden bg-primary py-24">
      ...
      <div className="relative mx-auto max-w-6xl px-6">
        <div className="mb-14 text-center">
          <p className="text-xs uppercase tracking-[0.5em] text-accent">Get in touch</p>
          <h2 className="mt-4 text-4xl font-bold text-white sm:text-5xl">Let's Work Together</h2>
