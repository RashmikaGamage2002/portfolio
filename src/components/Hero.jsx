...
const Hero = () => {
  ...
  return (
    <section
      id="home"
      className="min-h-screen relative overflow-hidden bg-primary flex items-center"
    >
      {/* ─── Background ────────────────────────────────────────────────────── */}
      ...
      {/* ─── Content ────────────────────────────────────────────────────────── */}
      <div className="relative z-10 w-full mx-auto px-4 sm:px-6 lg:px-8 py-12 sm:py-16">
        <motion.div
          initial="hidden"
          animate="visible"
        ...
        >
          {/* "Hi, I'm" */}
          <motion.p
            className="text-[12px] uppercase tracking-[0.4em] text-gray-500 mb-3 sm:mb-4"
            variants={fadeIn}
          ...
          {/* ─── Name – Two lines on mobile, one line on desktop ───────────── */}
          <motion.h1
            className="font-black uppercase leading-[0.9] tracking-tighter"
            variants={fadeUp}
            transition={{ delay: 0.25, duration: 0.8, ease: [0.77, 0, 0.18, 1] }}
          >
            <span className="text-[13vw] sm:text-[9vw] md:text-[8vw] lg:text-[7vw] xl:text-[8rem] text-[#E6DACE] block sm:inline">
              Rashmika
            </span>
            <span
              className="text-[13vw] sm:text-[9vw] md:text-[8vw] lg:text-[7vw] xl:text-[8rem] text-transparent block sm:inline"
              style={{ WebkitTextStroke: '2px #E6DACE' }}
            >
              Gamage
            </span>
          </motion.h1>
          ...
          {/* Description */}
          <motion.p
            className="mx-auto mt-4 sm:mt-6 max-w-2xl text-sm sm:text-base font-light leading-relaxed text-gray-400 px-4"
            variants={fadeUp}
          ...
          >
            ...
            <motion.a
              href="#projects"
              className="inline-flex items-center justify-center gap-2 rounded-full border border-white/20 bg-white/5 px-7 sm:px-9 py-3.5 sm:py-4 text-sm font-medium text-white transition-all hover:border-accent/30 hover:text-accent"
              whileHover={{ scale: 1.02 }}
              whileTap={{ scale: 0.98 }}
            >
              View My Work
          ...
          >
            {[
              ...
              <motion.a
                ...
                className="flex h-11 w-11 sm:h-12 sm:w-12 items-center justify-center rounded-full border border-white/10 bg-white/5 text-gray-300 transition-colors hover:border-accent/30 hover:text-accent"
